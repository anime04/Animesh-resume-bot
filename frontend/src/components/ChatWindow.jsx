...
export default function ChatWindow() {
  ...
  return (
    <div className="flex h-[100dvh] max-h-[100dvh] bg-base text-primary overflow-hidden font-sans">
      {/* Left Sidebar */}
      <Sidebar
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden relative">
        {/* Top Header */}
        <header className="flex-shrink-0 border-b border-border-subtle bg-surface/80 backdrop-blur-md z-10 px-2.5 sm:px-4 py-2 sm:py-3">
          <div className="max-w-panel mx-auto flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2 sm:gap-2.5 min-w-0">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  <h1
                    className="text-xs sm:text-base font-semibold tracking-tight truncate"
                    style={{ color: '#F5F4EF' }}
                  >
                    Animesh Jain
                  </h1>
            ...
            <div className="flex items-center gap-1.5 sm:gap-3 text-xs text-muted flex-shrink-0">
              <a
                href="https://linkedin.com/in/animesh-jain-349893258"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1 hover:text-accent transition-colors p-1"
              ...
              {messages.length > 0 && (
                <>
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 text-xs text-muted hover:text-primary transition-colors cursor-pointer p-1"
                  >
        ...
        <main className="flex-1 overflow-y-auto px-2.5 sm:px-4 py-2 sm:py-6 scroll-smooth">
          <div className="max-w-panel mx-auto min-h-full flex flex-col justify-start">
            {messages.length === 0 ? (
              <div className="py-2 sm:my-auto sm:py-8 space-y-2 sm:space-y-6 animate-fadeIn">
                <div className="space-y-1 sm:space-y-2">
                  <div className="inline-block px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full bg-surface-2 text-accent text-[10px] sm:text-xs font-mono border border-border-subtle mb-0.5">
